...
const StoryCard = ({ story }) => {
  ...
  return (
    <div
      data-theme="aqua"
      className="relative p-4 rounded-lg shadow-lg transform transition-transform hover:scale-105"
    >
      {isNew && (
        <div className="absolute top-0 right-0 m-2">
          <span className="badge badge-warning rounded-full text-white rotate-6">New</span>
        </div>
      )}
