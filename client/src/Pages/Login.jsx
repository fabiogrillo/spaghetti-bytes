      ...
      >
        ...
        >
          <div className="text-center mb-8">
            ...
            >
              <span className="badge badge-lg bg-error text-white shadow-soft px-6 py-3">
                Chef's Login
              </span>
            </motion.div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="form-control">
              <label className="label">
                <span className="label-text font-semibold flex items-center gap-2 text-gray-900 dark:text-white">
              ...
              <input
                type="email"
                className="input input-bordered w-full rounded-soft shadow-soft focus:shadow-soft-lg transition-all"
                value={email}
            ...
            {error && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="alert alert-error rounded-soft shadow-soft"
              >
                <span>{error}</span>
              </motion.div>
            )}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="btn btn-primary w-full rounded-soft shadow-soft-lg hover:shadow-soft-hover btn-lg"
              type="submit"
              disabled={loading}
            >
              {loading ? (
